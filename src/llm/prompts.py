...
2. **Preferred Skills**: Tools, platforms, certifications listed as "preferred" or "nice to have"
3. **Technical Terms**: Specific technologies, methodologies, protocols, standards mentioned
4. **Domain Terms**: Industry-specific terminology (e.g., "HIPAA", "FHIR", "PCI-DSS")
5. **Soft Skills**: Only if explicitly emphasized (e.g., "cross-functional collaboration", "stakeholder communication")
6. **Certifications**: Any mentioned certifications (AWS, Azure, PMP, etc.)
...
6. Match terminology from the job description
